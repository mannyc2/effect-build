...
await writeReceipt({
  ...
  sourceSha,
  claims: [{ id: "provider-version-boundaries", classification: "established", conclusion: "advertised-command-and-api-capabilities-exist-at-each-exercised-boundary", assertions: [assertion("bun-1.3.9-and-1.3.14"), assertion("deno-2.9.3-and-2.9.5"), assertion("esbuild-0.28.1-and-0.28.2")] }],
  evidence: result,
});
