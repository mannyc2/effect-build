...
await writeReceipt({
  ...
  sourceSha,
  claims: [
    { id: "same-version-node-sea", classification: "established", conclusion: "node-25.5.0-and-26.7.0-build-and-run-with-matching-base", assertions: [assertion("node-25-match"), assertion("node-26-match")] },
    { id: "mismatched-node-sea", classification: "falsified", conclusion: "node-26-builder-accepts-node-25-base-but-produced-executable-does-not-run", assertions: [assertion("builder-accepted-mismatch"), assertion("mismatched-output-execution-failed")] },
  ],
  evidence: result,
});
