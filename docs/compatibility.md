...
| Node SEA                                         | Matching builder/base Node versions 22–26; Mach-O bases need xcrun | Target is read from the base executable's header; Linux real-tool CI uses Node 22.0.0 and 26.7.0. Compiler versions do not change the orchestration floor.                                                            |
