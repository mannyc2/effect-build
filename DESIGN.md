...
| `Tool`       | `argumentIssue`, `locate`, `resolve`, `run`, `redact`, `parseVersion`, `satisfies`, `requireVersion`, `producer`                                                                                                 | Locate and resolve once, record path/version/hash. Nothing re-checks the binary later. Ranges use npm semver.                                                                                                              |
