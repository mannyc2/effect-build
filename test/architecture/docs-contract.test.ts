...
describe("documentation contract", () => {
  ...
  it("documents command compilers separately from granular integrations", async () => {
    ...
    expect(agents).toContain("Architecture generation: `post-0.3-surface-freeze-v1`");
    expect(agents).toContain("research/post-0.3/freeze/SURFACE.json");
    expect(agents).toContain("research/post-0.3/freeze/MIGRATION.json");
    ...
    expect(agents).toContain("Plans 039, 040, 041, 042, and 043 are complete at their export-inert stages");
    expect(agents).toContain("Plan 044 is ready to begin");
