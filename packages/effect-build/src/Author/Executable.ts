...
import type { AbsolutePath, Executable, HashedFile, ObservationMode, RuntimeObservation } from "../Artifact.js";
...
>(
  ...
  inspectCandidate: (candidate: HashedFile) => Effect.Effect<Inspection, InspectFailure, InspectRequirements>,
): Effect.Effect<
  Artifact<Mode>,
  Failure<ProduceFailure, InspectFailure>,
