...
```sh
npm install --save-dev --save-exact effect-build-rolldown@0.8.0 effect@4.0.0-rc.115 @effect/platform-node@4.0.0-rc.115 @effect/platform-node-shared@4.0.0-rc.115
```
