...
```sh
npm install --save-dev --save-exact effect-build-nfpm@0.8.0 effect@4.0.0-rc.113 @effect/platform-node@4.0.0-rc.113 @effect/platform-node-shared@4.0.0-rc.113
```
